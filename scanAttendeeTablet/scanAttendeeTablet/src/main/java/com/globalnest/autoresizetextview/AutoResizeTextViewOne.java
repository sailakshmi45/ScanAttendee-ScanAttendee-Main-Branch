...
/**
 * Created by mayank on 03/05/2017.
 */
 ...
 * @since Apr 4, 2011
 */
public class AutoResizeTextViewOne extends TextView {
    ...
    public AutoResizeTextViewOne(Context context) {
        this(context, null);
    }

    // Default constructor when inflating from XML file
    public AutoResizeTextViewOne(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    // Default constructor override
    public AutoResizeTextViewOne(Context context, AttributeSet attrs, int defStyle) {
