...
import com.globalnest.stripe.android.util.DateUtils;
import com.globalnest.stripe.android.util.TextUtils;
...
public class Card extends com.stripe.model.StripeObject {
    ...
    public Card(String number, Integer expMonth, Integer expYear, String cvc, String name) {
        this(number, expMonth, expYear, cvc, name, null, null, null, null, null, null, null, null, null, null);
        this.type = getType();
    }
