...
public class Stripe {
    ...
    private Map<String, Object> hashMapFromCard(Card card) {
        ...
        if(!AppUtils.NullChecker(card.getName()).isEmpty())
            cardParams.put("name", AppUtils.NullChecker(card.getName()));
        if(!AppUtils.NullChecker(card.getAddressLine1()).isEmpty())
            cardParams.put("address_line_1", AppUtils.NullChecker(card.getAddressLine1()));
        if(!AppUtils.NullChecker(card.getAddressLine2()).isEmpty())
            cardParams.put("address_line_2", AppUtils.NullChecker(card.getAddressLine2()));
        if(!AppUtils.NullChecker(card.getAddressCity()).isEmpty())
            cardParams.put("address_line_city", AppUtils.NullChecker(card.getAddressCity()));
        if(!AppUtils.NullChecker(card.getAddressZip()).isEmpty())
            cardParams.put("address_line_zip", AppUtils.NullChecker(card.getAddressZip()));
        if(!AppUtils.NullChecker(card.getAddressState()).isEmpty())
            cardParams.put("address_line_state", AppUtils.NullChecker(card.getAddressState()));
        if(!AppUtils.NullChecker(card.getAddressCountry()).isEmpty())
            cardParams.put("address_line_country", AppUtils.NullChecker(card.getAddressCountry()));
