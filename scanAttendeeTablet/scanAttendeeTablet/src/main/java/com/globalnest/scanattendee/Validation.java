...
//  Created by Ajay
//  This class contains all default validation like email, phone number and so on
...
public class Validation {
    ...
    public static boolean isPassword(EditText editText, boolean required, String errMsg) {
    	//Log.i("-----Eit Text Id----",":"+editText.getId());
    ...
    public static boolean hasValidDate(TextView editText,String msg, Date startDate, Date endDate) {
