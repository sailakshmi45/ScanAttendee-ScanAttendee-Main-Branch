...
//  Created by Ajay
//  This class is used for expand and collapse a view, used into AttendeeDetailActivity class
 //and allowing access of event listscreen
...
public class ExpandablePanel extends LinearLayout {
    ...
    public ExpandablePanel(Context context, AttributeSet attrs) {
        ...
        int handleId = a.getResourceId(
                    R.styleable.ExpandablePanel_handle1, 0);
        ...
        int contentId = a.getResourceId(
                        R.styleable.ExpandablePanel_content1, 0);
        if (contentId == 0) {
            throw new IllegalArgumentException(
